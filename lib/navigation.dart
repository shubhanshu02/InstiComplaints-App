      ...
      switch (user.connectionState) {
        ...
        case ConnectionState.done:
          if (user.hasError)
            ...
            final List<Widget> children1 = [Feed(), Notifications(),Profile(), Compose()];
            final List<Widget> children2= [Feed(), AdProfile(), ModifyModerators()];
          ...
          return Scaffold(
        body: (user.data['type']=='admin')?children2[currentIndex]:children1[currentIndex],
        bottomNavigationBar: (user.data['type']=='admin')?CurvedNavigationBar(
