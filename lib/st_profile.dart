        ...
        switch (user.connectionState) {
          ...
          case ConnectionState.done:
            ...
            for(var i=0;i<ls.length;i++){
              FirebaseFirestore.instance.collection('complaints').where('status', isEqualTo: 'resolved').where(FieldPath.documentId, isEqualTo: ls[i]).limit(1).get().then((data){return res_list.add(FieldPath.documentId.toString());});
            }
          return Scaffold(
        key: _scaffoldState,
        body: Stack(
                        ...
                        child: FlatButton(
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                child: Column(
                                  children: [
                                    Text((ls.length-res_list.length).toString(),
                                        style: TextStyle(
                                          fontSize: 25.0,
