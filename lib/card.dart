...
class _CardCategoryState extends State<CardCategory> {
                ...
                MaterialButton(
                  onPressed: () {
                    setState(() {
                      ...
                      'roomNo': customController.text.toString()
                    });
                    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
        stream:
          FirebaseFirestore.instance.collection('users').doc(user.uid).get().asStream(),
      builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> user) {
        ...
        children: [
          Card(
            elevation: 5.0,
            margin:EdgeInsets.symmetric(horizontal: query.size.width/14, vertical: query.size.height/80),
            child: Padding(
              ...
              content: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: hostels.map((e) => RadioListTile(
                      title: Text(e),
                      value:e,
