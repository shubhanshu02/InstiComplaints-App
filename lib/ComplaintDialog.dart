...
class _ComplaintDialogState extends State<ComplaintDialog> {
  ...
  void getd()async{
      bookmarked = await _userDocument.get().then((value) => value.data()['bookmarked']);
  }
                      ...
                      IconButton(
                        onPressed: ()async{
                          if(await _userDocument.get().then((value) => value.data()['bookmarked'].contains(widget._complaintID))){
                            _userDocument.update({'bookmarked':FieldValue.arrayRemove([FirebaseAuth.instance.currentUser.uid])});
                            setState(() {
                              bookmarked =false;
                            });
                          }
                          else{
                            _userDocument.update({'bookmarked':FieldValue.arrayUnion([FirebaseAuth.instance.currentUser.uid])});
                            setState(() {
                              bookmarked=true;
                            });
                          }
