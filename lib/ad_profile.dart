      ...
      builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> user) {
        switch (user.connectionState) {
          ...
          case ConnectionState.done:
            ...
            List<String> ls=List.from(user.data['list of my filed Complaints']);
            ...
            Container(
              ...
              child: Padding(
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                child: Column(
                                  children: [
                                  StreamBuilder(
                                      stream:FirebaseFirestore.instance.collection('complaints').where('status', isEqualTo: 'passed').where('category', isEqualTo: user.data['category']).snapshots(),
                                      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> passed){
                                        if(passed.connectionState==ConnectionState.waiting){
                                          return Loading();
                                        }
                                          return Text(passed.data.docs.length.toString(),
                                          style: TextStyle(
                                            fontSize: 25.0,
                                            color: Colors.grey[800],
                                            fontFamily: 'Roboto',
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                child: Column(
                                  children: [
                                    StreamBuilder(
                                      stream:FirebaseFirestore.instance.collection('complaints').where('status', isEqualTo: 'resolved').where('category', isEqualTo: user.data['category']).snapshots(),
                                      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> resolved){
                                        if(resolved.connectionState==ConnectionState.waiting){
                                          return Loading();
                                        }
                                          print(resolved.data);
                                          return Text(resolved.data.docs.length.toString(),
                                          style: TextStyle(
                                            fontSize: 25.0,
                                            color: Colors.grey[800],
                                            fontFamily: 'Roboto',
                  ...
                  Card(
                      elevation: 5.0,
                      margin:
                          EdgeInsets.symmetric(horizontal: query.size.width/14, vertical: query.size.height/80),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
