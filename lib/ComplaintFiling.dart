...
class ComplaintFiling{
  ...
  Future fileComplaint(String title,String category,String description,List<String> images,DateTime filingTime,String status,List<String> upvotes,String uid,String email) async {
